...
class Snake:
	def __init__(self):
		...
		# self.eat_sound = pygame.mixer.Sound(os.path.join(file_path, "eat.mp3"))
		# self.wall_hit_sound = pygame.mixer.Sound(os.path.join(file_path, "wall.mp3"))
...
food_surface = pygame.image.load(os.path.join(file_path, "food.png"))
